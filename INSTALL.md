...
5. Rename the extracted folder from `super-automation-main` to `super-automation`.
6. Copy the renamed `super-automation` folder into your agent's skills directory.
...
This repository is the `super-automation` skill. Keep the full `super-automation` folder together when installing it.
